...
func (d *DBusMessage) Copy(err **L.Error) *DBusMessage    { return DBusMessageCopy(d, err) }
...
func (d *DBusMessage) ToGerror(err **L.Error) bool { return DBusMessageToGerror(d, err) }
...
func (d *Drive) GetVolumes() *L.List                  { return DriveGetVolumes(d) }
