...
var (
	...
	actionDoAction         func(a *Action, i int) T.Gboolean
	...
	actionSetDescription   func(a *Action, i int, desc string) T.Gboolean
)

func (a *Action) DoAction(i int) T.Gboolean     { return actionDoAction(a, i) }
...
func (a *Action) SetDescription(i int, desc string) T.Gboolean {
